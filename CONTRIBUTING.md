...
Thank you for your interest in contributing to Kos! This document provides guidelines and instructions for contributing.
...
└── packages/
    ├── core/        # @kos/core - Shared types
    ├── shared/      # @kos/shared - Business logic
    └── ui/          # @kos/ui - React components
```
