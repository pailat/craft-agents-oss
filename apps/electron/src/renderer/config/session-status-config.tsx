...
import type { StatusConfig } from '@kos/shared/statuses'
import { isEmoji } from '@kos/shared/utils/icon-constants'
import { resolveEntityColor, getDefaultStatusColor } from '@kos/shared/colors'
import type { EntityColor } from '@kos/shared/colors'
