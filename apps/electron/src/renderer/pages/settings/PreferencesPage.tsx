 ...
 * PreferencesPage
 *
 * Form-based editor for stored user preferences (~/.kos/preferences.json).
 * Features:
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 min-h-0 mask-fade-y">
        <ScrollArea className="h-full">
          ...
          <SettingsSection
            title="Basic Info"
            description="Help Kos personalize responses to you."
          >
            <SettingsCard divided>
              <SettingsInput
                label="Name"
                description="How Kos should address you."
              ...
              <SettingsInput
                label="Language"
                description="Preferred language for Kos's responses."
          ...
          <SettingsSection
            title="Notes"
            description="Free-form context that helps Kos understand your preferences."
            action={
          ...
          >
            <SettingsCard divided={false}>
              <SettingsTextarea
                ...
                placeholder="Any additional context you'd like Kos to know..."
                rows={5}
                inCard
              />
            </SettingsCard>
