...
import { KosLogo } from '@/components/icons/KosLogo'
...
export const iconComponents: ComponentEntry[] = [
  {
    ...
    name: 'KosLogo',
    category: 'Icons',
    description: 'Kos wordmark logo — K + ring O + SLAB',
    component: KosLogo,
    props: [
      {
        name: 'className',
  ...
  },
  {
    ...
    name: 'KosSymbol',
    category: 'Icons',
    description: 'Kos concentric rings with Spark center (brand color: #532b88)',
    component: KosSymbol,
    props: [
      {
        name: 'className',
