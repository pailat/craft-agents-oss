...
import { TurnCard, UserMessageBubble, groupMessagesByTurn, formatTurnAsMarkdown, formatActivityAsMarkdown, type Turn, type AssistantTurn, type UserTurn, type SystemTurn, type AuthRequestTurn } from "@kos/ui"
...
import { flattenLabels } from "@kos/shared/labels"
...
interface ChatDisplayProps {
  ...
  labels?: import('@kos/shared/labels').LabelConfig[]
...
export const ChatDisplay = React.forwardRef<ChatDisplayHandle, ChatDisplayProps>(function ChatDisplay({
  ...
  // These settings are stored in ~/.kos/preferences.json (not localStorage)
  ...
  // Uses the shared extractOverlayData parser from @kos/ui
