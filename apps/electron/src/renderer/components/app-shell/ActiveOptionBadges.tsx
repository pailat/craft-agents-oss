...
import { PERMISSION_MODE_CONFIG, type PermissionMode } from '@kos/shared/agent/modes'
...
import { flattenLabels, parseLabelEntry, formatLabelEntry } from '@kos/shared/labels'
