...
echo "=== Building Kos AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: Kos-x86_64.AppImage or Kos-aarch64.AppImage
BUILT_APPIMAGE_NAME="Kos-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: Kos-x64.AppImage, Kos-arm64.AppImage
APPIMAGE_NAME="Kos-${ARCH}.AppImage"
