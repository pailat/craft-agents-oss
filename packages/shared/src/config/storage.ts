...
import type { StoredAttachment, StoredMessage } from '@kos/core/types';
...
import type { Workspace, AuthType } from '@kos/core/types';
...
/**
 * Load config defaults from ~/.kos/config-defaults.json
...
export function ensureConfigDir(): void {
  ...
  // Initialize bundled docs (creates ~/.kos/docs/ with sources.md, agents.md, permissions.md)
  initializeDocs();
...
export type { StoredAttachment, StoredMessage } from '@kos/core/types';
 ...
 * Preset themes are stored at ~/.kos/themes/
 */
...
/**
 * Returns the path to the tool-icons directory: ~/.kos/tool-icons/
 */
