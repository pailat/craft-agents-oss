 ...
 *
 * File locations:
 * - Workspace: ~/.kos/workspaces/{slug}/permissions.json
 * - Per-source: ~/.kos/workspaces/{slug}/sources/{sourceSlug}/permissions.json
 *
 ...
 * Default permissions are stored at ~/.kos/permissions/
 */
...
/**
 * Load default permissions from ~/.kos/permissions/default.json
...
class PermissionsConfigCache {
  ...
  // App-level default permissions (loaded from ~/.kos/permissions/default.json)
   ...
   * These come from ~/.kos/permissions/default.json
   */
