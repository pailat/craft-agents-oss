 ...
 * Guides are now served exclusively via the kos-docs MCP server.
 *
 ...
 * Use the kos-docs MCP server to search for setup guides.
 *
 * Example: mcp__kos-docs__SearchKos({ query: "github source setup guide" })
 */
