/**
 * Generates index.html showcasing all @kos/mermaid rendering capabilities.
 *
...
<head>
  ...
  <meta property="og:image" content="https://kos.ai/mermaid/og-image.png" />
  <meta property="og:type" content="website" />
  <meta property="og:url" content="https://kos.ai/mermaid" />
  ...
  <meta name="twitter:image" content="https://kos.ai/mermaid/og-image.png" />
  <!-- Plausible Analytics -->
  <script defer data-domain="kos.ai/mermaid" src="https://plausible.io/js/script.js"></script>
...
<body>
  ...
  <div class="theme-bar" id="theme-bar">
    <div class="brand-badge-wrapper">
      ...
      <div class="brand-dropdown shadow-modal-small" id="brand-dropdown">
        <a href="https://kos.ai" class="brand-dropdown-item" target="_blank" rel="noopener">
          <svg width="18" height="18" class="brand-dropdown-logo" style="margin-left: -4px;" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="100" cy="100" r="78" stroke="#532b88" stroke-width="15"/><circle cx="100" cy="100" r="55" stroke="#532b88" stroke-width="15"/><circle cx="100" cy="100" r="32" fill="#FC7A1E"/></svg>
          <span style="margin-left: -2px;">Kos<span class="tagline">From chaos, clarity.</span></span>
        </a>
      </div>
    </div>
  ...
  <header class="hero-header">
    ...
    <p class="hero-description">
      ...
      Built by the team at <a href="https://kos.ai" target="_blank" rel="noopener">Kos</a> — because diagrams deserve great design too.
    </p>
    <div class="hero-buttons">
      <a href="https://kos.ai" target="_blank" rel="noopener" class="hero-btn hero-btn-primary">
        <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="100" cy="100" r="78" stroke="currentColor" stroke-width="15"/><circle cx="100" cy="100" r="55" stroke="currentColor" stroke-width="15"/><circle cx="100" cy="100" r="32" fill="#FC7A1E"/></svg>
        Use in Kos
      </a>
...
${bundleJs}
  ...
  <footer class="site-footer">
    <span>&copy; 2026 Kos Inc. All rights reserved.</span>
    <div class="footer-links">
      <a href="mailto:support@kos.ai">Contact</a>
